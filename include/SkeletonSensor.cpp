...
void SkeletonSensor::setFOV(double fHFOV, double fVFOV)
{
		XnFieldOfView fov;
		fov.fHFOV = fHFOV; //1.0225999419141749;
		fov.fVFOV = fVFOV; //0.79661567681716894;
		depthG_.SetGeneralProperty(XN_PROP_FIELD_OF_VIEW, sizeof(fov), &fov);
}
